...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra [ create_bd_port -dir I -from 8 -to 0 addra ]
  set addrb [ create_bd_port -dir I -from 8 -to 0 addrb ]
  set dclk_in [ create_bd_port -dir I -type clk dclk_in ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {50000000} \
 ] $dclk_in
  set doutb [ create_bd_port -dir O -from 11 -to 0 doutb ]
  ...
  connect_bd_net -net Net [get_bd_ports addra] [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins ila_0/probe1]
  ...
  connect_bd_net -net dclk_in_1 [get_bd_ports dclk_in] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins ila_0/clk] [get_bd_pins xadc_wiz_0/dclk_in]
  connect_bd_net -net reset_in_1 [get_bd_ports reset_in] [get_bd_pins xadc_wiz_0/reset_in]
  connect_bd_net -net wea_1 [get_bd_ports wea] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net xadc_wiz_0_channel_out [get_bd_pins xadc_wiz_0/channel_out] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins blk_mem_gen_0/dina] [get_bd_pins ila_0/probe0] [get_bd_pins xlslice_0/Dout]
